...
public class SpawEntity implements Action {
    ...
    public void perform(GameMap gameMap) {
        ...
        gameMap.setStaticObjects(new Coordinates(10, 10),new Predator(2, 3, new Coordinates(10, 10), MapField.FILLED, coordinateService));
        ...
        gameMap.setStaticObjects( new Coordinates(1, 1),new Herbivore(2, 4, new Coordinates(11, 1), MapField.FILLED, coordinateService));
